...
// Detail panel for a single game with a Join / Leave action.
export default function GameDetailPanel({ game, onClose, onJoin, onLeave, onRequireAuth }) {
  const { user } = useAuth()
      ...
      <dl className="detail-list">
        ...
        <div>
          ...
          <dd>
            ...
            <span className="reliability" title="Reliability score">
              ⭐ {game.host?.reliability_score ?? 100}
            </span>
          </dd>
        </div>
        <div>
